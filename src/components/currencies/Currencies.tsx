...
const Currencies: FC<CurrentCurrency> = ({
  currentCurrency,
  setNewCurrency,
}): JSX.Element => {
  ...
  return (
    <div className={style.CurrencyBlock}>
      ...
      <div className={style.Currency_btns}>
        <button
          onClick={handleClick}
          className={`${style.CurrencyBlock_btn} ${
            currentCurrency === "RUB" ? style.active : ""
          }`}
        >
          RUB
        </button>
        <button
          onClick={handleClick}
          className={`${style.CurrencyBlock_btn} ${
            currentCurrency === "USD" ? style.active : ""
          }`}
        >
          USD
        </button>
        <button
          onClick={handleClick}
          className={`${style.CurrencyBlock_btn} ${
            currentCurrency === "EUR" ? style.active : ""
          }`}
        >
          EUR
        </button>
